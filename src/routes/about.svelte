...
<p>Scryline is built on the precept that aggregation is not just potentially illuminating synthesis which can be important and valuable in its own right; rather, in today's fragmented media world, it is increasingly <i>essential</i>, in order to provide key context and foster real understanding.</p>
