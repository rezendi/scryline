...
<p>"But surely the job of journalism is to make sense of all this!" you cry. Yes... theoretically... but journalism as we know it suffers from a number of flaws which make it unsuitable for this sort of synthesis:</p>

<ul>
    <li>Journalists are generally loath to link to their competitors.</li>
    <li>They're often even surprisingly reluctant to link to primary sources.</li>
    <li>They still have a "dead tree" attitude towards articles -- that they are individual and self-contained, and that once published they are set in stone but for corrections -- rather than treating them as connected nodes in a network of living documents.</li>
    <li>The open-source concept of incorporating suggestions from strangers into their articles after publication is unthinkable anathema.</li>
    <li>Aggregation of others' articles is considered inferior and low-class work.</li>
</ul>

<p>Scryline is built on the precept that aggregation is not just potentially illuminating synthesis which can be important and valuable in its own right; rather, in today's fragmented media world, it is increasingly essential in order to provide key context and foster real understanding.</p>
