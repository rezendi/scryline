...
<ul>
    <li>Journalists remain loath to link to primary sources, much less competitors' articles.</li>
    <li>Journalists still have a "dead tree" attitude towards what they publish:
...
is <i>essential</i>. This makes tools which enable collaborative aggregation highly
